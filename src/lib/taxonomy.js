 ...
 */
/*
 * Apologies to Rob Levin, whose code this is.
 * I had to extend update() a bit, and
 * ended up plagarizing the entire library
 */
    ...
    var update = function(id, newData, otherData = {}) {
        ...
        _.each(root.data, function(obj) {
            if(!theMatch) {
                ...
                if(match) {
                    match.data = newData;
                    match = Object.assign(newData, match);
                    theMatch = match;
                }
            }
        });
